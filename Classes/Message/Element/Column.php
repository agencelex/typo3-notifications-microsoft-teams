...
/**
 * A single column used inside a ColumnSet.
 *
...
final class Column implements Renderable
{
    ...
    /**
     * Extend the column to cover surrounding padding when true.
     */
    ...
    /**
     * Minimum height of the column (CSS value, e.g. "100px").
     */
    ...
    /**
     * Vertical alignment of content within the column.
     *
     ...
     * Column width.
     *
     * Accepted values: "auto", "stretch", a pixel string ("50px"),
     * or a proportional weight ("1", "2", …).
     */
